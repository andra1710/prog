...
class main {
	...
	// Figure 8 using the previously made ode45.
		...
		// the starting values from the articel
		...
		RungeKutta.driver(f, start, iv, stop, xlist, ylist);

		using(var outfile = new System.IO.StreamWriter("figure8.txt")){
