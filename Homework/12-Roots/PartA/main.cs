...
public class main{
	...
	public static void Main(){
		...
		WriteLine("This extremum is found at: x = {res1[0]}, and the Analytical result is 0.6065");
		...
		WriteLine("This extremum is found at:x = {res2[0]}, y = {res2[1]}m the Analytical result is (1,1)");
	}
